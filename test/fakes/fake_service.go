...
type FakeService struct {
	...
	ServiceDiscoveryStub        func() (*api.Client, *api.AgentServiceRegistration, error)
...
func (fake *FakeService) ServiceDiscovery() (*api.Client, *api.AgentServiceRegistration, error) {
	...
	fake.recordInvocation("ServiceDiscovery", []interface{}{})
	fake.serviceDiscoveryMutex.Unlock()
	if fake.ServiceDiscoveryStub != nil {
		return fake.ServiceDiscoveryStub()
	}
	if specificReturn {
...
func (fake *FakeService) ServiceDiscoveryCalls(stub func() (*api.Client, *api.AgentServiceRegistration, error)) {
	fake.serviceDiscoveryMutex.Lock()
